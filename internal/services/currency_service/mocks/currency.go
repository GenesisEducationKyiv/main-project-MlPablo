...
// Package mock_currency_service is a generated GoMock package.
package mock_currency_service
...
func (m *MockICurrencyAPI) GetCurrency(ctx context.Context, data *rate_domain.Rate) (float64, error) {
	m.ctrl.T.Helper()
