...
type CurrencyServiceClient interface {
	GetCurrency(ctx context.Context, in *Rate, opts ...grpc.CallOption) (*Currency, error)
}
...
func (c *currencyServiceClient) GetCurrency(ctx context.Context, in *Rate, opts ...grpc.CallOption) (*Currency, error) {
	out := new(Currency)
	err := c.cc.Invoke(ctx, "/grpc_currency_service.CurrencyService/GetCurrency", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CurrencyServiceServer interface {
	GetCurrency(context.Context, *Rate) (*Currency, error)
}
...
func (UnimplementedCurrencyServiceServer) GetCurrency(context.Context, *Rate) (*Currency, error) {
...
func _CurrencyService_GetCurrency_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc_currency_service.CurrencyService/GetCurrency",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CurrencyServiceServer).GetCurrency(ctx, req.(*Rate))
	}
...
var CurrencyService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grpc_currency_service.CurrencyService",
